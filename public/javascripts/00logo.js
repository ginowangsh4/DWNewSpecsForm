...
function buildData(){
    var txtData =
            ...
            "\r\n##############################" +
            "\r\nDo you want your organization name in the logo?: "+$("#logoInput").val()+
...
$(function(){
    ...
    $("#submitLink").click(function(event){
        ...
        $(this).attr('download',"Logo_"+$("#nameInput").val()+'_'+$('#organizationInput').val()+'.txt')
            .attr('href',"data:application/octet-stream;base64,"+Base64.encode(txtData));
        var subject = '[New Specs Response] '+ $("#nameInput").val() + ' - Logo design';
