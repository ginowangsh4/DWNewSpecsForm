...
function buildData(){
    var txtData =
            ...
            "\r\n##############################" +
            "\r\nHow many pages should the brochure be?: "+$("#pageInput").val()+
            "\r\n" +
            "\r\nWhat paper size?: "+$("#papersizeInput").val()+
            "\r\n" +
            "\r\nWhat text would you like to include on each page?: "+$("#textInput").val()+
...
$(function(){
    ...
    $("#submitLink").click(function(event){
        ...
        $(this).attr('download',"Brochure_"+$("#nameInput").val()+'_'+$('#organizationInput').val()+'.txt')
            .attr('href',"data:application/octet-stream;base64,"+Base64.encode(txtData));
        var subject = '[New Specs Response] '+ $("#nameInput").val() + ' - Brochure design';
